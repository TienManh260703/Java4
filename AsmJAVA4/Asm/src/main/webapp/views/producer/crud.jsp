...
<div class="container">
    <form action="/producer/update?id=${pd.id}" method="post" class="mb-3">
        <div class="row">
            <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label>Tên Màu</label>
                    <input class="form-control" type="text" name="name" ${btn == 0 ? "readonly" : ""} value="${pd.name}">
                </div>
            </div>
        </div>
        ...
        <c:choose>
            <c:when test="${btn eq 0}">
                <a href="/producer/list" class="btn btn-primary mt-3 mb-3" style="direction: none">
                    Quay lai
                </a>
            </c:when>
            <c:otherwise>
