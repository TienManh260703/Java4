...
<html>
<head>
    <title>Trang nhà sản xuẩt</title>
...
<div class="container">
    <form action="/product-line/add" method="post">
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label>Tên tên dóng sản phẩm</label>
    ...
    <table class="table mt-3">
        ...
        <tbody>
        <c:forEach var="pd" items="${productLineList}">
            <tr>
                <th scope="row">${pd.id}</th>
                <td>${pd.code}</td>
                <td>${pd.name}</td>
                <td>
                    <a href="/producer/view-update?id=${pd.id}" >
                        <button  class="btn btn-warning"> Update</button>
                    </a>
                    <a href="/producer/detail?id=${pd.id}"  >
                        <button class="btn btn-info"> Detail</button>
                    </a>
                    <a href="/producer/delete?id=${pd.id}"  >
