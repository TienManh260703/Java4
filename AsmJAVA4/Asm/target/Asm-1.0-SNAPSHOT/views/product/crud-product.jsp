...
<div class="container">
    <form action="/product/update?id=${p.id}" method="post" class="mb-3">
        <div class="row">
            <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="name" ${btn == 0 ? "readonly" : ""} value="${p.name}">
                </div>
            </div>
        </div>
        ...
        <c:choose>
            <c:when test="${btn eq 0}">
                <a href="/product/list" class="btn btn-primary mt-3 mb-3" style="direction: none">
                    Quay lai
                </a>
            </c:when>
            <c:otherwise>
