...
<div class="container">
    <form action="/customer/update?id=${c.id}" method="post">
        <!-- Hàng 1 -->
        <div class="row">
            <div class="col-md-2">
                <div class="mb-3">
                    <label for="code" class="form-label">Mã</label>
                    <input type="text" class="form-control" id="code" name="code" value="${c.code}">
                </div>
            </div>
            <div class="col-md-2">
                <div class="mb-3">
                    <label for="firstName" class="form-label">Tên</label>
                    <input type="text" class="form-control" id="firstName" name="firstName" value="${c.firstName}">
                </div>
            </div>
            <div class="col-md-2">
                <div class="mb-3">
                    <label for="middleName" class="form-label">Tên đệm</label>
                    <input type="text" class="form-control" id="middleName" name="middleName" value="${c.middleName}">
                </div>
            </div>
            <div class="col-md-2">
                <div class="mb-3">
                    <label for="lastName" class="form-label">Họ</label>
                    <input type="text" class="form-control" id="lastName" name="lastName" value="${c.lastName}">
                </div>
            </div>
            <div class="col-md-2">
                <div class="mb-3">
                    <label for="dateStr" class="form-label">Ngày sinh</label>
                    <input type="text" class="form-control" id="dateStr" name="dateStr" value="${c.dateStr}">
                </div>
            </div>
        </div>
        <!-- Hàng 2 -->
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="address" name="address" value="${c.address}">
                </div>
            </div>
            <div class="col-md-3">
                <div class="mb-3">
                    <label for="city" class="form-label">Thành phố</label>
                    <input type="text" class="form-control" id="city" name="city" value="${c.city}">
                </div>
            </div>
            <div class="col-md-3">
                <div class="mb-3">
                    <label for="country" class="form-label">Quốc gia</label>
                    <input type="text" class="form-control" id="country" name="country" value="${c.country}">
                </div>
            </div>
        </div>
